...
integer iter
real razao2, diferenca_interpol1, diferenca_interpol2, tempomedio
real diferenca, ajuda, lambda, kreal, aux_real, razao, desquadrado
real deslocamentox, deslocamentoy, deslocamentoz, deslocamentomedio
real, allocatable :: dx2(:), temposed(:)
...
real, allocatable :: posinicial(:,:)
real, allocatable :: posfinal(:,:)
integer, allocatable :: contador(:)
...
integer nb,nbr
real rij(3), rn(3)
real l, h, laux, haux, dx
integer npast
integer ncor
real phi, densityratio
...
real tempo, Xo, Yo
real ti, tf, tpros
real reale, reale2, Str, freqcampo
integer inteiro, inteiro2, loop, loop2, loop3
integer auxiliar1
